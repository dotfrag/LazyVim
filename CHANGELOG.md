...
## [13.0.0](https://github.com/dotfrag/LazyVim/compare/v12.18.0...v13.0.0) (2024-06-22)
...
* **copilot-chat:** ctrl-s now works in both normal and insert mode ([0fcadce](https://github.com/dotfrag/LazyVim/commit/0fcadced89f96f59a9f9cb0c85ee73990df1219f))
...
* **extra:** add prisma support and config ([#3684](https://github.com/dotfrag/LazyVim/issues/3684)) ([1101c3e](https://github.com/dotfrag/LazyVim/commit/1101c3ed24709feec85371a951ea0feed6bd50fa))
...
* **fzf:** basic image viewing support ([cda30f2](https://github.com/dotfrag/LazyVim/commit/cda30f2740f0479098e93a546a741aeefad535cc))
...
* **gitsigns:** new keymap for `Gitsigns blame` ([#3758](https://github.com/dotfrag/LazyVim/issues/3758)) ([b22831b](https://github.com/dotfrag/LazyVim/commit/b22831b7e25a4681df171da30204d4d4f7e9abfa))
...
* **mini.pairs:** allow to skip pairs in certain treesitter nodes ([d6bea06](https://github.com/dotfrag/LazyVim/commit/d6bea06a82912e324ec86438708e619aaa3adce0))
* **mini.pairs:** and now the actual code :) ([540261d](https://github.com/dotfrag/LazyVim/commit/540261d74d2a743f3bff7eb9749cddeea1d29b19))
* **mini.pairs:** enable mini.pairs in the cmdline ([2daca4b](https://github.com/dotfrag/LazyVim/commit/2daca4b51014a1a14ce8a5ccdd9fdf08a51db3db))
...
* **outline:** free ctrl-k /ctrl+j ([#3686](https://github.com/dotfrag/LazyVim/issues/3686)) ([31c2ad7](https://github.com/dotfrag/LazyVim/commit/31c2ad7dac2e711018b3e1393c5b995515b2ef5e))
* **php:** allow using intelephense instead of phpactor in php extras ([#3691](https://github.com/dotfrag/LazyVim/issues/3691)) ([ea3b5cc](https://github.com/dotfrag/LazyVim/commit/ea3b5cc2ab4ff7d70163ab66ea7fa0acc0e88566))
...
* **project:** add fzf-lua keymap descriptions ([#3690](https://github.com/dotfrag/LazyVim/issues/3690)) ([07ab681](https://github.com/dotfrag/LazyVim/commit/07ab681b1d6f0223e6b265f3eb6aaafbd12e5c0e))
* **project:** add some fzf-lua keymap ([#3666](https://github.com/dotfrag/LazyVim/issues/3666)) ([f24999f](https://github.com/dotfrag/LazyVim/commit/f24999fd3645756a338137278ccc4fa3e1240a90))
...
* **treesitter-textobjects:** added ]a and [a to move between parameters ([18c7731](https://github.com/dotfrag/LazyVim/commit/18c7731281f7a9886ae98d9c034661fa85340fb2))
...
* **cmp:** visible ([57ef349](https://github.com/dotfrag/LazyVim/commit/57ef349910ec40c7024f3b50a549aabefa1ebbf0))
...
* **conform:** `lsp_format` breaking changes ([#3707](https://github.com/dotfrag/LazyVim/issues/3707)) ([a69e626](https://github.com/dotfrag/LazyVim/commit/a69e626d7a3a027df124bae7b2672658a4fb5b0f))
...
* **dap:** get the correct debugpy pkg path on windows ([#3716](https://github.com/dotfrag/LazyVim/issues/3716)) ([06f13da](https://github.com/dotfrag/LazyVim/commit/06f13daf7261377ecfa6b4ac845d742f446df719))
...
* **edgy:** only enable edgy neo-tree when needed. Fixes [#3697](https://github.com/dotfrag/LazyVim/issues/3697). Closes [#3703](https://github.com/dotfrag/LazyVim/issues/3703) ([bdca1e9](https://github.com/dotfrag/LazyVim/commit/bdca1e95ff97348501a715bd6aa5977422a27969))
...
* **extras.python:** avoid launching extra console with dap on Windows ([#3723](https://github.com/dotfrag/LazyVim/issues/3723)) ([67eece6](https://github.com/dotfrag/LazyVim/commit/67eece6d74f071035ca7b934a753d71d1677dd9b))
...
* **git:** removed debug info ([d9caee6](https://github.com/dotfrag/LazyVim/commit/d9caee610038548a4b79f2b6eb126180ec8ba6b6))
...
* **lazygit:** support monorepo structure and other git providers ([#3701](https://github.com/dotfrag/LazyVim/issues/3701)) ([1f034e1](https://github.com/dotfrag/LazyVim/commit/1f034e16000692d1d0ec8e02110d37cf2089bd4c))
...
* **lsp:** dont highlight document words when cmp is visible ([0d57115](https://github.com/dotfrag/LazyVim/commit/0d57115f01b4094f68e426942e14892f204ec664))
...
* **pick:** remove the unused commands attribute ([#3673](https://github.com/dotfrag/LazyVim/issues/3673)) ([eca8692](https://github.com/dotfrag/LazyVim/commit/eca86924510676667a3868efc512588749f6594e))
...
* **root:** also check root_dir. Fixes [#3732](https://github.com/dotfrag/LazyVim/issues/3732) ([d4991d5](https://github.com/dotfrag/LazyVim/commit/d4991d5aac3c4ab5865e65d73fb8957b3d61bdc3))
...
* **snippets:** nvim-snippets `&lt;S-Tab&gt;` prev key ([#3712](https://github.com/dotfrag/LazyVim/issues/3712)) ([492fa86](https://github.com/dotfrag/LazyVim/commit/492fa86faa29f2987f662ad0cdb796b5c1c49ef3))
...
* **statuscolumn:** `%r` deprecated in nightly and `%l` handles everything ([#3719](https://github.com/dotfrag/LazyVim/issues/3719)) ([1a295c5](https://github.com/dotfrag/LazyVim/commit/1a295c5ef8cab02c6054067c35ca805a3e4ccf72))
* **statuscolumn:** fix `folds_open = true` ([#3756](https://github.com/dotfrag/LazyVim/issues/3756)) ([b47c65f](https://github.com/dotfrag/LazyVim/commit/b47c65f4087c4d82720ab7439f395aba5d6b5f40))
...
* **telescope:** default to follow=true ([b87d18c](https://github.com/dotfrag/LazyVim/commit/b87d18cc17300c49bf8bec4b81a3416024a39a21))

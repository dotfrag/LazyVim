...
## [13.0.0](https://github.com/dotfrag/LazyVim/compare/v12.15.0...v13.0.0) (2024-06-15)
...
* **copilot-chat:** use fzf-lua if enabled in extras ([#3590](https://github.com/dotfrag/LazyVim/issues/3590)) ([7252474](https://github.com/dotfrag/LazyVim/commit/7252474624cda30cac399b7f419ad25665e62a8f))
...
* **extras:** added fzf-lua ([#3555](https://github.com/dotfrag/LazyVim/issues/3555)) ([6ab4041](https://github.com/dotfrag/LazyVim/commit/6ab404134db6004aab13dcf956e200ff063b2d42))
...
* **fzf:** added ctrl-u and ctrl+d to scroll in the results list ([9f2a369](https://github.com/dotfrag/LazyVim/commit/9f2a3699a8f47467359f2c3defb3a711b32e0efb))
* **fzf:** added ctrl-x to jump with easymotion to a line, similar to flash telescope ([1c740ce](https://github.com/dotfrag/LazyVim/commit/1c740ce3fdb5e361ec20e5e8cca5a6a79b24ed44))
* **fzf:** better default window size/position ([74cf6e4](https://github.com/dotfrag/LazyVim/commit/74cf6e446247661ccb074838f92537c96a378ff4))
* **fzf:** better layout for code actions ([e948435](https://github.com/dotfrag/LazyVim/commit/e948435f17afbbccfe1e7f2b355977efce9f1ff8))
* **fzf:** better scrollbars ([8bb6538](https://github.com/dotfrag/LazyVim/commit/8bb653876c38518e4befb496b78659e76ed7afee))
* **fzf:** disable dressing in favor of noice (vim.ui.input) and fzf-lua (vim.ui.select) ([5c876b7](https://github.com/dotfrag/LazyVim/commit/5c876b754999eb5fe8b79c5b6f5249b5bbddb454))
* **fzf:** ignore current line for some lsp pickers ([c481861](https://github.com/dotfrag/LazyVim/commit/c4818616d541e4456850d1982be39b8151bd0f2a))
* **fzf:** prettier document symbols ([ba3aec7](https://github.com/dotfrag/LazyVim/commit/ba3aec7b4876e36a9f9fd3cce1d204c23c0fe24f))
* **fzf:** use delta previewer for code actions when available ([1697100](https://github.com/dotfrag/LazyVim/commit/16971006c250f11d5ee3cfc974da0c34ab159286))
* **fzf:** use vscode style path names formatter ([14d1ca9](https://github.com/dotfrag/LazyVim/commit/14d1ca93d0e927b60fdf43424158f2336437f3a6))
...
* **lang:** add clojure support ([#2179](https://github.com/dotfrag/LazyVim/issues/2179)) ([913902b](https://github.com/dotfrag/LazyVim/commit/913902ba362603a4620f8981fdedac7f53816b3a))
...
* **lualine:** show readonly icon ([#3567](https://github.com/dotfrag/LazyVim/issues/3567)) ([21617a9](https://github.com/dotfrag/LazyVim/commit/21617a9d602f2400c8e9813490958e106cb88ca8))
...
* **mini.pairs:** added some custom options to make mini.pairs behave better ([bf809ad](https://github.com/dotfrag/LazyVim/commit/bf809ad2a1f6cd8f74451feacdd79af68d201d6e))
...
* **noice:** added support for fzf-lua. Closes [#3596](https://github.com/dotfrag/LazyVim/issues/3596) ([ec3dba2](https://github.com/dotfrag/LazyVim/commit/ec3dba20af86187a44c953eb326725f76559cc12))
...
* **octo:** re-open octo windows when restoring session + cleanup ([7793942](https://github.com/dotfrag/LazyVim/commit/7793942ebafd32ef90f79e28979898f8013976ff))
...
* **pick:** move pickers to extras (telescope still the default) ([#3606](https://github.com/dotfrag/LazyVim/issues/3606)) ([39a908c](https://github.com/dotfrag/LazyVim/commit/39a908c9faca2387c5444de89191275b7bd02576))
* **prettier:** prettier is now enabled for all supported filetypes and no longer requires a config file by default ([7d50bf0](https://github.com/dotfrag/LazyVim/commit/7d50bf0626f768b4d036b500ff204835fa405b74))
...
* **prettier:** with the prettier & astro extra, prettier will be enabled if the prettier-astro-plugin is available ([214f5fc](https://github.com/dotfrag/LazyVim/commit/214f5fccdf468030b05851ebfbef8394485322fb))
* **project:** ctrl-t opens project in tab ([f28937b](https://github.com/dotfrag/LazyVim/commit/f28937b0c53195a90fb450d0f07bacd3321a0cfd))
...
* **svelte:** with prettier & svelte extra, prettier will be enabled when prettier-plugin-svelte is available ([945143a](https://github.com/dotfrag/LazyVim/commit/945143a34e298541989a9f050a3fb2ced6646e9e))
...
* **util:** added LazyVim.has_extra ([b714f28](https://github.com/dotfrag/LazyVim/commit/b714f286623cca6e3da31df43c4cf4354a46c36d))
* **util:** added LazyVim.memoize ([5a11d74](https://github.com/dotfrag/LazyVim/commit/5a11d740e119d392858b97b69470201e66e66212))
...
* **yanky:** added fzf-lua support ([82f680e](https://github.com/dotfrag/LazyVim/commit/82f680ee6b681f9f39fbfb8431a4f362af134d1c))
...
* **clojure:** removed rainbow delimiters and fixed some plugin setups. Closes [#3530](https://github.com/dotfrag/LazyVim/issues/3530) ([cfa8c9f](https://github.com/dotfrag/LazyVim/commit/cfa8c9fbd45a36784f76d4842bc385828214ee1c))
* **cmp:** don't enable `snippets` source without `nvim-snippets` ([#3527](https://github.com/dotfrag/LazyVim/issues/3527)) ([af80811](https://github.com/dotfrag/LazyVim/commit/af80811be01f5349544a1b21e9dd03f0e25fefca))
...
* **dap:** make sure mason-dap is loaded after initializing dap. See [#3663](https://github.com/dotfrag/LazyVim/issues/3663) ([e0e1ab0](https://github.com/dotfrag/LazyVim/commit/e0e1ab01af01f393d4c96f943faddcc62f6eda16))
* **dap:** make sure mason-nvim-dap loads after nvim-dap ([2b703ac](https://github.com/dotfrag/LazyVim/commit/2b703ac125a21b48bb207d86cddbb461189d025b))
* **dap:** set host to 127.0.0.1 instead of localhost to prevent issues with ipv6. Fixes [#3577](https://github.com/dotfrag/LazyVim/issues/3577) ([9b8a393](https://github.com/dotfrag/LazyVim/commit/9b8a393edc8b9a12a39f712163f6476c084a7f71))
...
* **dashboard:** proper fix for dashboard's weird action loading ([1d50c75](https://github.com/dotfrag/LazyVim/commit/1d50c75a4b149f1cf00f4d4163f1469bc2fa77fc))
...
* **edgy:** neo-tree. See [#3667](https://github.com/dotfrag/LazyVim/issues/3667) ([f22a602](https://github.com/dotfrag/LazyVim/commit/f22a6022c4e97bc8dc6060479fe4188e1a953c1e))
* **edgy:** only track other neo-tree windows with a source ([6efbdab](https://github.com/dotfrag/LazyVim/commit/6efbdabd1b2272401566354686ce85e1372fe925))
* **editor:** telescope init error when trouble.nvim is disabled ([#3518](https://github.com/dotfrag/LazyVim/issues/3518)) ([c452fd7](https://github.com/dotfrag/LazyVim/commit/c452fd730c94bfcbb5f9f4af1cae3c851f9456a3))
* **egdy:** do not add panes for not enabled neo-tree sources ([#3667](https://github.com/dotfrag/LazyVim/issues/3667)) ([67616b9](https://github.com/dotfrag/LazyVim/commit/67616b9520a5309d2e3565ff880b37ceef662179))
* **elixir:** add missing lspconfig ([#3661](https://github.com/dotfrag/LazyVim/issues/3661)) ([06f5ef9](https://github.com/dotfrag/LazyVim/commit/06f5ef928f61dbb64ee0555cddf556bc01cc62f4))
* **extra-lang-angular:** add BufNew event to attach angular treesitter ([#3522](https://github.com/dotfrag/LazyVim/issues/3522)) ([fbb1276](https://github.com/dotfrag/LazyVim/commit/fbb1276ffd45683d4d64a2d99907bdbd3421c16f))
...
* **extras.copilot-chat:** small ui fix for which-key in visual mode ([#3573](https://github.com/dotfrag/LazyVim/issues/3573)) ([43afed1](https://github.com/dotfrag/LazyVim/commit/43afed121195df6591d0e941b913b98f849c8af3))
...
* **extras:** +prefix in which-key panel for visual mode ([#3537](https://github.com/dotfrag/LazyVim/issues/3537)) ([5185404](https://github.com/dotfrag/LazyVim/commit/51854046dbb0bacf690ddc217cc76bf98c8ec1aa))
...
* **extras:** better reasons as to why some extras are included in your config. ([eeccbbc](https://github.com/dotfrag/LazyVim/commit/eeccbbc40721bb825182251acf201750741c77b2))
* **extras:** load prettier extra before svelte/astro ([4980574](https://github.com/dotfrag/LazyVim/commit/49805748d4cefc077cc0c81e864f1757198fc3f4))
...
* **formatting:** remove deprecation check on some options ([c16fb5d](https://github.com/dotfrag/LazyVim/commit/c16fb5d49bfe10041fb36f6ac80a755767b9e6bf))
...
* **fzf:** action desc ([c6ddb23](https://github.com/dotfrag/LazyVim/commit/c6ddb2328d596771ee562f49462ae10dfc49321f))
* **fzf:** added action descriptions. (still doesnt work for trouble) ([19a6e2d](https://github.com/dotfrag/LazyVim/commit/19a6e2de158e63264aaa761228a1e3f9d615bd57))
* **fzf:** cleanup ([79b7c48](https://github.com/dotfrag/LazyVim/commit/79b7c489fdacd0a04e7025e72e9020c4ff595eb3))
* **fzf:** disable mini.indentscope in fzf-lua buffer ([#3592](https://github.com/dotfrag/LazyVim/issues/3592)) ([0ba67c8](https://github.com/dotfrag/LazyVim/commit/0ba67c87e9054e09d562164de7ed1876587a0539))
* **fzf:** esc and c-j, c-k keymaps with nowait. update fzf-lua as well ([c9380a3](https://github.com/dotfrag/LazyVim/commit/c9380a309dbdc9fe45ec1bc9f8f27700540c2eea))
* **fzf:** esc and nowait ([7c7703d](https://github.com/dotfrag/LazyVim/commit/7c7703d79226cda99b1ec3d25fbfff54af04ba5b))
* **fzf:** floating previewer closed fail ([#3638](https://github.com/dotfrag/LazyVim/issues/3638)) ([427e57d](https://github.com/dotfrag/LazyVim/commit/427e57ddf7030f7081d858d923fb9337f94bf0a7))
* **fzf:** live document symbols. Fixes [#3587](https://github.com/dotfrag/LazyVim/issues/3587) ([056042b](https://github.com/dotfrag/LazyVim/commit/056042b221c93a14c6069d4a82b7435fc9a228fd))
* **fzf:** lowercase symbols ([d1d24fa](https://github.com/dotfrag/LazyVim/commit/d1d24fa077add680bc532e08fd68aaa0841a14dc))
* **fzf:** only add trouble integration when trouble is available ([e1f587a](https://github.com/dotfrag/LazyVim/commit/e1f587a43dce83c652db5c6742cf516d983152a3))
* **fzf:** symbols filter ([7e0ac68](https://github.com/dotfrag/LazyVim/commit/7e0ac6850b613ba8cbc179fa2f71199184504a54))
...
* **helm:** missing dependency ([#3546](https://github.com/dotfrag/LazyVim/issues/3546)) ([02dd65c](https://github.com/dotfrag/LazyVim/commit/02dd65cdea1ae34cdf4ca00b20760dbb3cfcd72b))
...
* **issue template:** repro.lua didn't work ([#3628](https://github.com/dotfrag/LazyVim/issues/3628)) ([25cccb5](https://github.com/dotfrag/LazyVim/commit/25cccb5db858ad0640fd6a9eb5da4c5f465749d9))
...
* **lang:** neotest not loading rust tests ([#3544](https://github.com/dotfrag/LazyVim/issues/3544)) ([0567b37](https://github.com/dotfrag/LazyVim/commit/0567b37f61d5ad997793b950c38a6c8f73de3b9b))
...
* **lsp:** add file completion to rename file ([52b5728](https://github.com/dotfrag/LazyVim/commit/52b572881b6fcbc805e5e584c4970c920d314f86))
...
* **luasnip:** disable nvim-snippets when luasnip is enabled. Fixes [#3547](https://github.com/dotfrag/LazyVim/issues/3547) ([aa059e0](https://github.com/dotfrag/LazyVim/commit/aa059e0d496e570f898644d3f18bc344ca179d38))
...
* **neo-tree:** use last window for preview ([#3560](https://github.com/dotfrag/LazyVim/issues/3560)) ([caaa6c4](https://github.com/dotfrag/LazyVim/commit/caaa6c440d5c3b80c03cad1dfd93989b852bb875))
...
* **php:** formatting and linting ([#3540](https://github.com/dotfrag/LazyVim/issues/3540)) ([f5dc867](https://github.com/dotfrag/LazyVim/commit/f5dc867ac29e31f833442006ebe3daf7540d1f69))
...
* **pick:** allow configuring pickers without LazyExtras. Fixes [#3626](https://github.com/dotfrag/LazyVim/issues/3626) ([304e743](https://github.com/dotfrag/LazyVim/commit/304e7439aa8ae646adafb737b292707bf77a31d9))
* **pick:** ignore registering the same picker ([48a70aa](https://github.com/dotfrag/LazyVim/commit/48a70aa8f5e201dc6c0a4997f4084193dd9b29a5))
* **pick:** move some leftovers from `editor.lua` to `editor.telescope` ([#3620](https://github.com/dotfrag/LazyVim/issues/3620)) ([b9f7264](https://github.com/dotfrag/LazyVim/commit/b9f726404fce2f5db8bfec713ed3e053537586ad))
* **pick:** recent files in cwd. Fixes [#3580](https://github.com/dotfrag/LazyVim/issues/3580) ([d541069](https://github.com/dotfrag/LazyVim/commit/d541069fdffcf5ffaf2a7f161fd87bb68094c8cf))
* **pick:** use LazyVim.pick instead of M since dashboard dumps/loadstrings functions. Why though... Fixes [#3617](https://github.com/dotfrag/LazyVim/issues/3617) ([425e6e0](https://github.com/dotfrag/LazyVim/commit/425e6e0ea3006c87645240d003a3b289cbfc446a))
...
* **prettier:** fixup ([ac9217b](https://github.com/dotfrag/LazyVim/commit/ac9217b1994ad00b488ba73021d89afac03873ee))
...
* **project:** add fzf-lua integration. Fixes [#3609](https://github.com/dotfrag/LazyVim/issues/3609) ([4b9e4ed](https://github.com/dotfrag/LazyVim/commit/4b9e4edbb115f1f13906b2cdb68986e336b05729))
* **project:** telescope name ([d82c11f](https://github.com/dotfrag/LazyVim/commit/d82c11f889b03effa5248170ac1b4b4681391f08))
...
* **python:** only enable venv-selector when telescope is availble. See [#3612](https://github.com/dotfrag/LazyVim/issues/3612) ([74c1766](https://github.com/dotfrag/LazyVim/commit/74c1766479411357054819b5d8c8376ca12c2504))
...
* **rust:** incorporate latest changes from `rustaceanvim` ([#3655](https://github.com/dotfrag/LazyVim/issues/3655)) ([2d68976](https://github.com/dotfrag/LazyVim/commit/2d689763e43f9c744f4893a6d68fcb8308502053))
...
* **rust:** make neotest optional ([547dc76](https://github.com/dotfrag/LazyVim/commit/547dc76a12309d4dafc970ae08832140eae51cba))
...
* **sql:** make sure edgebars exist. Fixes [#3578](https://github.com/dotfrag/LazyVim/issues/3578) ([bd29f45](https://github.com/dotfrag/LazyVim/commit/bd29f4515307f59437995d5cc0ba601eb02b5baa))
...
* **typescript:** clean up configuration of the vscode dap extension ([#3556](https://github.com/dotfrag/LazyVim/issues/3556)) ([1c46f54](https://github.com/dotfrag/LazyVim/commit/1c46f544328b084753327a81b92e2b57ab568321))
* **typescript:** implemented move to new file. Fixes [#3534](https://github.com/dotfrag/LazyVim/issues/3534) ([d90930b](https://github.com/dotfrag/LazyVim/commit/d90930b13e4515a5f4e4f3892ac9f7c392c4f20c))
...
* **ui:** use `LazyVim.pick` for alpha.nvim and mini.starter extras ([#3611](https://github.com/dotfrag/LazyVim/issues/3611)) ([339979d](https://github.com/dotfrag/LazyVim/commit/339979d3143d46a37c304d45a00c7a4f448e707d))
...
* **util:** ensure unique cache keys in LazyVim.memoize ([#3576](https://github.com/dotfrag/LazyVim/issues/3576)) ([3354872](https://github.com/dotfrag/LazyVim/commit/335487282a128d6df7ea021a75b31f07a2b9ccfd))
...
* **vue:** disable inlay hints for vue, since they seem broken ([3233385](https://github.com/dotfrag/LazyVim/commit/3233385ddb61d01f87de374c061696a374596a10))
* **vue:** disable volar hybrid mode since it interferes with tsserver ([#3654](https://github.com/dotfrag/LazyVim/issues/3654)) ([5070694](https://github.com/dotfrag/LazyVim/commit/5070694861f91ac258fbf851ed771294cafafb8f))
...
* "fix(dap): set host to 127.0.0.1 instead of localhost to prevent issues with ipv6. Fixes [#3577](https://github.com/dotfrag/LazyVim/issues/3577)" ([a3547e4](https://github.com/dotfrag/LazyVim/commit/a3547e4b3b03e019dbe7e543104ffd1ea82fa765))
